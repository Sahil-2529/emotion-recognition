...
Original file is located at
    https://colab.research.google.com/drive/1ROu1He7ceZ8o188TOaqQe0PHydb8rZS5
"""
...
for dirname, _, filenames in os.walk('/content/tess toronto emotional speech set data'):
    for filename in filenames:
        ...
        file_label = filename.split('_')[-1] # Use file_label instead of label to avoid overwriting
        file_label = file_label.split('.')[0]
        labels.append(file_label.lower())
    if len(paths) == 2800:
        break
